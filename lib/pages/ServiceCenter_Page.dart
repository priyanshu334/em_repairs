...
class _ServiceCenterPageState extends State<ServiceCenterPage> {
  ...
  void initState() {
    super.initState();
    // Fetch service centers when the page is loaded
  ...
  void _submitDetails(ServiceCenterProvider provider) {
    ...
    if (name.isNotEmpty && number.isNotEmpty && address.isNotEmpty) {
      final serviceCenter = ServiceCenterModel(
        id: null, // ID will be generated by Appwrite
        name: name,
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Service Center Added: $name')),
      );
      _clearFields();
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void _editServiceCenter(ServiceCenterProvider provider, ServiceCenterModel serviceCenter) {
    ...
    // Set an update flag or action (this can be implemented in many ways)
    // In this case, we're just reusing the submit button for editing as well
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 24),
                // Displaying existing service centers (if any)
                Expanded(
